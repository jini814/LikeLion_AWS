...
function getTodos(){
    ...
    xhr.open("get","http://43.201.65.21:8080/api/todos");
...
function updateTodo(id){
    ...
    xhr.open('PATCH','http://43.201.65.21:8080/api/todos/'+id);
...
function deleteTodo(id){
    let delTodo = {"id": id};
    let xhr = new XMLHttpRequest();
    xhr.open('DELETE','http://43.201.65.21:8080/api/todos');
    xhr.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
...
function postTodo(todo){
    let xhr = new XMLHttpRequest();
    xhr.open('post','http://43.201.65.21:8080/api/todos');
    xhr.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
    xhr.onload = function(){
